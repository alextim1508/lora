...
public class ServiceUUIDs {
    ...
    /*UUID сервиса UART*/
    public static final UUID UART_SERVICE_UUID = UUID.fromString("00000000-cc7a-482a-984a-7f2ed5b3e58f");

    /* UUID характеристики для отправки данных в устройство (виртуальный "TX" на стороне устройства)*/
    public static final UUID UART_WRITE_CHAT_UUID = UUID.fromString("000000ff-8e22-4541-9d4c-21edae82ed19");

    /*UUID характеристики для получения данных от устройства (виртуальный "RX" на стороне устройства, с поддержкой notify)*/
    public static final UUID UART_NOTIFY_CHART_UUID = UUID.fromString("00000000-8e22-4541-9d4c-21edae82ed19");
